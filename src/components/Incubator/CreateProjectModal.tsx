...
/* ============================================================
   ...
   Overlay modal for creating a new project in the incubator.
      ...
      >
        ...
        <header style={styles.header}>
          <div style={styles.headerLeft}>
            ...
            <span style={styles.headerTitle}>NEW PROJECT</span>
          </div>
          <button
            onClick={handleClose}
        ...
        <div style={styles.body}>
          ...
          <div style={styles.fieldGroup}>
            ...
            <textarea
              ...
              placeholder="Describe the mission parameters for this project..."
        ...
        <footer style={styles.footer}>
          ...
          <span style={styles.keyboardHint}>
            ...
            <span style={styles.keyboardHintText}>to create</span>
          </span>
